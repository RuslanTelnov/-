    ...
    return (
        <div style={{ minHeight: '100vh', background: 'var(--velveto-bg-primary)' }}>
            <header style={{
                ...
                <div style={{ color: 'var(--velveto-text-secondary)', fontSize: '0.7rem', textTransform: 'uppercase' }}>
                    Settings & API Keys
                </div>
            </header>
            ...
            <main className="container" style={{ paddingTop: '4rem', maxWidth: '1000px', margin: '0 auto', paddingBottom: '4rem' }}>
                <div style={{ marginBottom: '3rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '1.5rem' }}>
                    <div>
                        ...
                        <h2 style={{ fontSize: '1.8rem', fontWeight: '200', color: 'var(--velveto-text-primary)' }}>НАСТРОЙКИ</h2>
                    </div>
...
function SettingInput({ name, value, onChange }) {
    ...
    return (
        <motion.div className="velveto-card" style={{ padding: '1rem 1.5rem', border: '1px solid rgba(255,255,255,0.03)' }}>
            ...
            <input
                ...
                style={{
                    width: '100%', fontSize: '0.9rem', color: 'var(--velveto-text-primary)', fontFamily: 'monospace',
