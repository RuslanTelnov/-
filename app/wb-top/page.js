    ...
    return (
        <div style={{ minHeight: '100vh', background: 'var(--velveto-bg-primary)' }}>
            ...
            <main className="container" style={{ padding: '2rem 1rem', maxWidth: '1600px', margin: '0 auto' }}>
                ...
                {/* Search & Controls */}
                <div style={{ display: 'flex', flexWrap: 'wrap', gap: '1rem', justifyContent: 'center', marginBottom: '3rem', alignItems: 'center' }}>
                    <form onSubmit={(e) => handleParse(e)} style={{ display: 'flex', gap: '1rem', alignItems: 'center', flexWrap: 'wrap', justifyContent: 'center', width: '100%', maxWidth: '600px' }}>
                        <input
                            type="text"
                            value={query}
                                ...
                                <table className="ms-table">
                                    ...
                                    <tbody>
                                        {filteredProducts.map(p => (
                                            <tr key={p.id}>
                                                <td data-label="Выбор"><input type="checkbox" checked={selectedIds.has(p.id)} onChange={() => toggleSelect(p.id)} /></td>
                                                <td data-label="Товар">
                                                    <div style={{ display: 'flex', gap: '1rem', alignItems: 'center' }}>
                                                        <div
                                                            style={{ width: '50px', height: '60px', borderRadius: '6px', overflow: 'hidden', cursor: 'pointer', position: 'relative', flexShrink: 0 }}
                                                        ...
                                                        <div>
                                                            ...
                                                            <div style={{ fontSize: '0.75rem', opacity: 0.5, display: 'flex', gap: '0.5rem', alignItems: 'center', flexWrap: 'wrap' }}>
                                                                ID: {p.id}
                                                                <a
                                                ...
                                                <td data-label="Цена" style={{ fontSize: '1.1rem', fontWeight: '600', color: 'var(--velveto-accent-primary)' }}>{p.price_kzt} ₸</td>

                                                <td data-label="Доставка" style={{ color: 'var(--velveto-text-secondary)', fontSize: '0.9rem' }}>
                                                    {p.delivery_days > 0 ? (
                                                ...
                                                <td data-label="Наличие" style={{ textAlign: 'center' }}>
                                                    {p.in_stock ? (
                                                        <div style={{
                                                ...
                                                {/* STATUS COLUMNS */}
                                                <td data-label="Статус Конвейера" style={{ minWidth: '180px' }}>
