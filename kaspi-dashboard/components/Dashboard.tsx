      ...
      <main className="flex-1 flex flex-col overflow-hidden relative">
        ...
        <header className="px-8 py-6 flex justify-between items-center z-30">
          ...
          <div className="flex items-center gap-6">
            ...
            <button id="step-sync" onClick={handleSync} disabled={syncing || loading} className="neon-button px-6 py-3 rounded-full flex items-center gap-2">
        ...
        <div className="flex-1 overflow-y-auto px-8 pb-8 z-10">
          ...
          <section className="mb-8 grid grid-cols-1 lg:grid-cols-5 gap-6">
            <div id="step-balance" className="lg:col-span-2 glass-fintech rounded-[2rem] p-8 relative overflow-hidden group">
          ...
          <section id="step-warehouses" className="mb-8">
          ...
          <section id="step-metrics" className="mb-8 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <section id="step-charts" className="grid grid-cols-1 lg:grid-cols-2 gap-8">
